...
export interface OneAtomAnchorPointProps extends OneAtomCommonPropType {
...
export const AnchorPoint: FC<OneAtomAnchorPointProps> = function OneAtom_AnchorPoint({ name, top, left, children }) {
