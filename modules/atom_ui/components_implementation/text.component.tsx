...
export interface OneAtomTextProps extends OneAtomCommonPropType {}

interface PropsForCustom extends OneAtomTextProps {
  size?: number;
  spacing?: number;
  weight?: number;
}
...
export namespace Text {
  export const h: FC<OneAtomTextProps> = function OneAtom_Text({ children, className }) {
    return <elements.text className={className}>{children}</elements.text>;
  };

  export const h1_plus: FC<OneAtomTextProps> = function OneAtom_Text_h1_plus({ children, className }) {
    return (
  ...
  export const h1: FC<OneAtomTextProps> = function OneAtom_Text_h1({ children, className }) {
    return (
      <Text.h className={className}>
  ...
  export const h2: FC<OneAtomTextProps> = function OneAtom_Text_h2({ children, className }) {
    return (
      <Text.h className={className}>
  ...
  export const h3: FC<OneAtomTextProps> = function OneAtom_Text_h3({ children, className }) {
    return (
      <Text.h className={className}>
  ...
  export const h4: FC<OneAtomTextProps> = function OneAtom_Text_h4({ children, className }) {
    return (
      <Text.h className={className}>
  ...
  export const body: FC<OneAtomTextProps> = function OneAtom_Text_h4({ children, className }) {
    return (
      <Text.h className={className}>
