...
export interface OneAtomButtonProps extends OneAtomBaseButtonProps, OneAtomSizeProps, OneAtomCommonPropType {
  round?: boolean;
}
...
const elements = {
  ...
  `,
  controlButton: styled(elementsShared.button)`
...
export namespace Button {
  export const action: FC<OneAtomButtonProps> = function OneAtom_Button_action({
    children,
    fluid,
    className,
    round,
  ...
  export const alt: FC<OneAtomButtonProps> = function OneAtom_Button_control({
    children,
    fluid,
    className,
    round,
  ...
  export const h: FC<OneAtomButtonProps> = function OneAtom_Button({ children, fluid, className, type = 'action', ...rest }) {
    return (
      <Size fluid={fluid}>
        <elementsShared.button className={className ?? ''} {...rest}>
          {children}
        </elementsShared.button>
      </Size>
    );
  };
}
